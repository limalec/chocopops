...
{   
    ...
    for (var i = 0; i < player1.bullets.length; i++)
    {
        ...
        if (player2.life > 0 && 
            player1.bullets[i].position.x - 10 < player2.graphic.position.x &&
            player1.bullets[i].position.x + 10 > player2.graphic.position.x &&
            player1.bullets[i].position.y + 10 > player2.graphic.position.y &&
            player1.bullets[i].position.y - 10 < player2.graphic.position.y
            )
        {
            player2.life -= 100
...
function player_collision()
{
    ...
    if ( player2.life > 0 && 
        player1.graphic.position.x - 10 < player2.graphic.position.x &&
        player1.graphic.position.x + 10 > player2.graphic.position.x &&
        player1.graphic.position.y + 10 > player2.graphic.position.y &&
        player1.graphic.position.y - 10 < player2.graphic.position.y )
    {
        player1.life -= 1
